...
$q=$mysqli->query("SELECT AVG(tempC), AVG(tempF), AVG(humidity), YEAR(date_add(time_stamp,INTERVAL -5 HOUR)), MONTH(date_add(time_stamp,INTERVAL -5 HOUR)), DAY(date_add(time_stamp,INTERVAL -5 HOUR)), HOUR(date_add(time_stamp,INTERVAL -5 HOUR)), date_add(time_stamp,INTERVAL -5 HOUR) 
FROM esp32_dht20 GROUP BY YEAR(date_add(time_stamp,INTERVAL -5 HOUR)), MONTH(date_add(time_stamp,INTERVAL -5 HOUR)), DAY(date_add(time_stamp,INTERVAL -5 HOUR)), HOUR(date_add(time_stamp,INTERVAL -5 HOUR)) ORDER BY time_stamp DESC LIMIT 24
");
