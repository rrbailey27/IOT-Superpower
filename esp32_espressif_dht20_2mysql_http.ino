...
const char * hostDir = "/example/esp32_dht20_superpower/esp32_add2database.php";
...
http://00.00.00.00/example/esp32SF_helloworld/esp32_add2database.php?event=fromscript
*/
